...
public:
	...
	//int Get_number_copies() const { return number_copies; }
	//setter
	...
	//void Set_number_copies() { number_copies++; }
...
private:
	...
	int year_appearance;
	float price_book;
	//for upgrade, count number of same books in library
	//static int number_copies;
};